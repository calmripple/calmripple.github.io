...
🤖 【中文注释】
  工具名称: Agent推荐助手
  功能分类: 通用助手
  功能说明: 用于推荐适合当前仓库的 Copilot Custom Agents，避免重复并识别过时工具。
  使用方式: 在 VS Code 中通过 Copilot Chat 输入 /suggest-awesome-github-copilot-agents 命令调用。
  关键标签: Copilot、推荐、Agent、辅助
-->
