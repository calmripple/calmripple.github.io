...
|                                     优化前                                      |                                     优化后                                      |
| :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| ![](./assets/2024-blog-perf-001.png) | ![](./assets/2024-blog-perf-002.png) |
...
|                                    性能面板                                     |                                   lighthouse                                    |
| :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| ![](./assets/2024-blog-perf-003.png) | ![](./assets/2024-blog-perf-004.png) |
...
|                                     七牛云                                      |                                     又拍云                                      |                                     缤纷云                                      |
| :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| ![](./assets/2024-blog-perf-007.png) | ![](./assets/2024-blog-perf-008.png) | ![](./assets/2024-blog-perf-009.png) |
...
|                                      封面                                       |                                    友链头像                                     |                                      头像                                       |
| :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| ![](./assets/2024-blog-perf-010.png) | ![](./assets/2024-blog-perf-011.png) | ![](./assets/2024-blog-perf-012.png) |
...
![](./assets/2024-blog-perf-013.png)

② 将模型用到的PNG图片压缩

使用之前做的[图片在线压缩工具](https://demos.sugarat.top/pages/png-compress/)

![](./assets/2024-blog-perf-014.png)
...
|                                     七牛云                                      |                                     又拍云                                      |                                     缤纷云                                      |
| :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| ![](./assets/2024-blog-perf-015.png) | ![](./assets/2024-blog-perf-016.png) | ![](./assets/2024-blog-perf-017.png) |

优化前后对比
|                                     优化前                                      |                                     优化后                                      |
| :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| ![](./assets/2024-blog-perf-018.png) | ![](./assets/2024-blog-perf-019.png) |
...
![](./assets/2024-blog-perf-020.png)

![](./assets/2024-blog-perf-021.png)

② 针对后渲染区域，限定其容器的宽度，避免渲染后影响布局

![](./assets/2024-blog-perf-022.png)
...
|                                    性能面板                                     |                                   lighthouse                                    |
| :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| ![](./assets/2024-blog-perf-024.png) | ![](./2024-blog-perf/b5bae2c72f1d2aed2c09857c1b9e6b5f.png) |
