...
![图片](./assets/vite-react-js-001.png)
...
npm run dev
```
![图片](./assets/vite-react-js-002.png)

页面正常，接下来将`App.tsx`修改为`App.js`

将会得到上述的报错

![图片](./assets/vite-react-js-003.png)
...
![图片](./assets/vite-react-js-004.png)

## 解决方案
1. 修改依赖预构建的配置
2. 使用babel插件`@babel/plugin-transform-react-jsx`，让Vite在运行时对js文件转换

![图片](./assets/vite-react-js-005.png)
...
![图片](./assets/vite-react-js-006.png)
...
![图片](./assets/vite-react-js-007.png)
