...
![图片](./vite-react-js/MTYzNDAxNjYxMzEyNg==634016613126.png)
...
npm run dev
```
![图片](./vite-react-js/MTYzNDAxNTk3NjAwNQ==634015976005.png)

页面正常，接下来将`App.tsx`修改为`App.js`

将会得到上述的报错

![图片](./vite-react-js/MTYzNDAxNjA0ODYwMw==634016048603.png)
...
![图片](./vite-react-js/MTYzNDAxNjg3ODYwMg==634016878602.png)

## 解决方案
1. 修改依赖预构建的配置
2. 使用babel插件`@babel/plugin-transform-react-jsx`，让Vite在运行时对js文件转换

![图片](./vite-react-js/MTYzNDAxNzQyNDM2Mg==634017424362.png)
...
![图片](./vite-react-js/MTYzNDAxNzg4NjY4OQ==634017886689.png)
...
![图片](./vite-react-js/MTYzNDAxODAxNTMxMw==634018015313.png)
