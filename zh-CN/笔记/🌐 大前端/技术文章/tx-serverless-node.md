...
![图片](./tx-serverless-node/MTYyMTQxNDAwOTUxNg==621414009516.png)

然后在左上角的云产品列表中找到[Serverless应用中心](https://console.cloud.tencent.com/sls)

![图片](./tx-serverless-node/MTYyMzg1MDQ2Njg3Ng==623850466876.png)

然后你能看到如下的界面

![图片](./tx-serverless-node/MTYyMzg1MDUyOTAwOA==623850529008.png)

点击新建，可以看见有很多模板可供选择,咱这里先选择`Express`应用，然后点击下一步

![图片](./tx-serverless-node/MTYyMzg1MDU4ODUyMA==623850588520.png)
...
![图片](./tx-serverless-node/MTYyMzg1MDc3MzQ4NQ==623850773485.png)

填完基本信息后紧接着点击完成即可

![图片](./tx-serverless-node/MTYyMzg1MTI2Nzg1MA==623851267850.png)
...
![图片](./tx-serverless-node/MTYyMzg1MzI0Njc1MQ==623853246751.png)

## 线上访问地址

应用创建完成后能在卡片处看见后端服务的线上地址：

![图片](./tx-serverless-node/MTYyMzg1MTQzNzUyMw==623851437523.png)
...
![图片](./tx-serverless-node/MTYyMzg1MTU0MDQ4Mw==623851540483.png)

## 模板的源代码
选择卡片中的 `开发部署` -> `更新应用`

![图片](./tx-serverless-node/MTYyMzg1MTY3ODEwNA==623851678104.png)

紧接着 选择 `本地开发` ,点击下载项目

![图片](./tx-serverless-node/MTYyMzg1MTgyNDEzMg==623851824132.png)
...
![图片](./tx-serverless-node/MTYyMzg1NDQ3NDM2Ng==623854474366.png)

点击云函数蓝色的那个函数名称（是一个链接），就会跳转到WebIDE页面

![图片](./tx-serverless-node/MTYyMzg1NDYyODA1OQ==623854628059.png)
...
node -v
```
![图片](./tx-serverless-node/MTYyMTQxNzk1NjM2Nw==621417956367.png)
...
sls -v
```
![图片](./tx-serverless-node/MTYyMzg1NTY5MzQwMg==623855693402.png)
### 部署
...
![图片](./tx-serverless-node/MTYyMzg1NTc3MDY2Mg==623855770662.png)

此时静静等待几秒

![图片](./tx-serverless-node/MTYyMzg1NTg4ODkxMA==623855888910.png)

出现此图说明部署成功

![图片](./tx-serverless-node/MTYyMzg1NTkzMDUxNw==623855930517.png)
...
![图片](./tx-serverless-node/MTYyMzg1NjM4NDQyMw==623856384423.png)
