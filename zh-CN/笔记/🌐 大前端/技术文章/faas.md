...
![](./assets/faas-001.gif?s1=http%3A//wx3.sinaimg.cn/large/78b88159gy1gkr8mh459dg208w08cu0x.gif)
...
![图片](./assets/faas-002.png)

### 3. 云函数-函数服务

左上角选择云产品，输入云函数，选择 云函数-函数服务

![图片](./assets/faas-003.png)

### 4. 新建云函数

新建一个云函数

![图片](./assets/faas-004.png)
...
* 选择空白函数
* 然后下一步
![图片](./assets/faas-005.png)

### 6. 完成创建

直接点击完成，什么都不更改

![图片](./assets/faas-006.png)

### 7. 触发器

然后来到这个界面，点击触发管理

![图片](./assets/faas-007.png)
...
![图片](./assets/faas-010.png)

**我们的云函数代码**

![图片](./assets/faas-011.png)
...
![图片](./assets/faas-014.png)

![图片](./assets/faas-015.png)

选择在线安装依赖，然后点击保存

![图片](./assets/faas-016.png)

安装完成后 会出现 node_modules目录

![图片](./assets/faas-017.png)
...
![图片](./assets/faas-019.png)

![图片](./assets/faas-020.png)

## 最终代码

![图片](./assets/faas-021.png)
