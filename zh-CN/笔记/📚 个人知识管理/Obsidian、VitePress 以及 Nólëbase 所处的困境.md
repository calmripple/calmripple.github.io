...
status: 尚未完成
---
# 知与在（beknowing） 和我们所使用的 Obsidian 以及 VitePress 所处的困境
...
我试图通过在 知与在 中撰写大量的插件来解决这个问题，但事实是它并不好解决，借鉴于 VueUse，UnoCSS，Vite 和 Vue 文档的插件穿插在文档项目中难以维护，然后就可能会遇到你不得不为了更新脚本和插件而整个推送文档项目的情况，他们耦合在了一起，十分不方便。
