...
![图片](./assets/TxServerlessStatic_001.png)

然后在左上角的云产品列表中找到[云开发CloudBase](https://console.cloud.tencent.com/tcb/env/index?rid=4)

![图片](./assets/TxServerlessStatic_002.png)

然后你能看到如下的界面

![图片](./assets/TxServerlessStatic_003.png)

点击新建，可以看见有很多模板可供选择，咱们这里选择Vue应用，当然你也可以选择其它模板，我们主要是获得其生成的一个`cloudbaserc.json`文件，后文会详细介绍这个配置文件

![图片](./assets/TxServerlessStatic_004.png)

填写环境名称，选择按量计费（非常非常便宜），勾上**同意**，能勾上免费就勾上**免费资源**

填写完成后点击下一步

![图片](./assets/TxServerlessStatic_005.png)

点击立即开通

![图片](./assets/TxServerlessStatic_006.png)

接下来你能在当前页面看到刚刚创建的应用，记住这个环境id 后面会用上

![图片](./assets/TxServerlessStatic_007.png)
...
![图片](./assets/TxServerlessStatic_008.png)

选择左侧菜单中的静态网站托管

![图片](./assets/TxServerlessStatic_009.png)
...
node -v
```
![图片](./assets/TxServerlessStatic_010.png)
...
tcb -v
```
![图片](./assets/TxServerlessStatic_011.png)
...
![图片](./assets/TxServerlessStatic_012.png)
...
![图片](./assets/TxServerlessStatic_013.png)
...
![图片](./assets/TxServerlessStatic_014.png)

选择免费的

![图片](./assets/TxServerlessStatic_015.png)

然后下一步填写必要的信息

![图片](./assets/TxServerlessStatic_016.png)

选择DNS验证

![图片](./assets/TxServerlessStatic_017.png)
...
![图片](./assets/TxServerlessStatic_024.png)
...
![图片](./assets/TxServerlessStatic_027.png)

![图片](./assets/TxServerlessStatic_028.png)
...
![图片](./assets/TxServerlessStatic_029.png)

添加完成后如下图所示

![图片](./assets/TxServerlessStatic_030.png)
...
![图片](./assets/TxServerlessStatic_031.png)

在Action面板中也能看见任务的执行状态，点击可查看详细进度

![图片](./assets/TxServerlessStatic_032.png)

执行完成后如下图所示

![图片](./assets/TxServerlessStatic_033.png)
## 参考资料
