...
![图片](./tx-serverless-static-008.png)

选择左侧菜单中的静态网站托管

![图片](./tx-serverless-static-009.png)
...
node -v
```
![图片](./tx-serverless-static-010.png)
...
tcb -v
```
![图片](./tx-serverless-static-011.png)
...
![图片](./tx-serverless-static-012.png)
...
![图片](./tx-serverless-static-013.png)
...
![图片](./tx-serverless-static-014.png)

选择免费的

![图片](./tx-serverless-static-015.png)

然后下一步填写必要的信息

![图片](./tx-serverless-static-016.png)

选择DNS验证

![图片](./tx-serverless-static-017.png)

按要求添加一条解析规则

![图片](./tx-serverless-static-018.png)

我这里域名是在阿里云上购买的

![图片](./tx-serverless-static-019.png)

按要求添加解析

![图片](./tx-serverless-static-020.png)

添加完成后，点击查询域名验证状态即可，申请完成后如下图所示

![图片](./tx-serverless-static-021.png)

### 绑定域名

在静态网站托管tab 基础配置中添加自定义域名

![图片](./tx-serverless-static-022.png)

弹窗中输入刚刚申请证书用的域名

![图片](./tx-serverless-static-023.png)

根据要求添加CName

![图片](./tx-serverless-static-024.png)

上述添加解析步骤一样

![图片](./tx-serverless-static-025.png)
...
![图片](./tx-serverless-static-026.png)
...
![图片](./tx-serverless-static-027.png)

![图片](./tx-serverless-static-028.png)
...
![图片](./tx-serverless-static-029.png)

添加完成后如下图所示

![图片](./tx-serverless-static-030.png)
...
![图片](./tx-serverless-static-031.png)

在Action面板中也能看见任务的执行状态，点击可查看详细进度

![图片](./tx-serverless-static-032.png)

执行完成后如下图所示

![图片](./tx-serverless-static-033.png)
## 参考资料
* [文档:云开发 CloudBase](https://cloud.tencent.com/document/product/876)

<Citation type="转载" source="粥里有勺糖的博客" url="https://sugarat.top/technology/learn/tx-serverless-static.html" />
