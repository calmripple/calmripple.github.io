...
![图片](./assets/Faas_001.png)

### 3. 云函数-函数服务

左上角选择云产品，输入云函数，选择 云函数-函数服务

![图片](./assets/Faas_002.png)

### 4. 新建云函数

新建一个云函数

![图片](./assets/Faas_003.png)
...
* 选择空白函数
* 然后下一步
![图片](./assets/Faas_004.png)

### 6. 完成创建

直接点击完成，什么都不更改

![图片](./assets/Faas_005.png)

### 7. 触发器

然后来到这个界面，点击触发管理

![图片](./assets/Faas_006.png)
...
![图片](./assets/Faas_009.png)

**我们的云函数代码**

![图片](./assets/Faas_010.png)
...
![图片](./assets/Faas_013.png)

![图片](./assets/Faas_014.png)

选择在线安装依赖，然后点击保存

![图片](./assets/Faas_015.png)

安装完成后 会出现 node_modules目录

![图片](./assets/Faas_016.png)
...
![图片](./assets/Faas_018.png)

![图片](./assets/Faas_019.png)

## 最终代码

![图片](./assets/Faas_020.png)
...
<Citation type="转载" source="粥里有勺糖的博客" url="https://sugarat.top/technology/learn/faas.html" />
