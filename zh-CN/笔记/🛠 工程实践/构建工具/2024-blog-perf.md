...
|                                     优化前                                      |                                     优化后                                      |
| :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| ![](./assets/2024BlogPerf_001.png) | ![](./assets/2024BlogPerf_002.png) |
...
|                                    性能面板                                     |                                   lighthouse                                    |
| :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| ![](./assets/2024BlogPerf_003.png) | ![](./assets/2024BlogPerf_004.png) |
...
|                                     七牛云                                      |                                     又拍云                                      |                                     缤纷云                                      |
| :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| ![](./assets/2024BlogPerf_007.png) | ![](./assets/2024BlogPerf_008.png) | ![](./assets/2024BlogPerf_009.png) |
...
|                                      封面                                       |                                    友链头像                                     |                                      头像                                       |
| :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| ![](./assets/2024BlogPerf_010.png) | ![](./assets/2024BlogPerf_011.png) | ![](./assets/2024BlogPerf_012.png) |
...
|                                     七牛云                                      |                                     又拍云                                      |                                     缤纷云                                      |
| :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| ![](./assets/2024BlogPerf_015.png) | ![](./assets/2024BlogPerf_016.png) | ![](./assets/2024BlogPerf_017.png) |

优化前后对比
|                                     优化前                                      |                                     优化后                                      |
| :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| ![](./assets/2024BlogPerf_018.png) | ![](./assets/2024BlogPerf_019.png) |
...
![](./assets/2024BlogPerf_020.png)

![](./assets/2024BlogPerf_021.png)

② 针对后渲染区域，限定其容器的宽度，避免渲染后影响布局

![](./assets/2024BlogPerf_022.png)
...
|                                    性能面板                                     |                                   lighthouse                                    |
| :-----------------------------------------------------------------------------: | :-----------------------------------------------------------------------------: |
| ![](./assets/2024BlogPerf_024.png) | ![](./assets/2024BlogPerf_002.png) |
