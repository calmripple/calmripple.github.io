...
![](./vitepress-plugin-rss-002.png)

同时会在导航栏的 socialLinks 中添加 rss 图标链接

![](./vitepress-plugin-rss-003.png)
...
![](./vitepress-plugin-rss-008.png)

启动博客后就能看见右上角这个小太阳了

![](./vitepress-plugin-rss-009.png)
