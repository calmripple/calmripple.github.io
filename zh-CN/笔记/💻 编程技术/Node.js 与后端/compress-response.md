...
![图片](./assets/CompressResponse_001.png)

![图片](./assets/CompressResponse_002.png)
...
>下面的客户端均指浏览器
### accept-encoding
![accept-encoding](./assets/CompressResponse_003.png)

客户端在向服务端发起请求时，会在请求头(request header)中添加`accept-encoding`字段，其值标明客户端`支持的压缩内容编码`格式

### content-encoding
![content-encoding](./assets/CompressResponse_004.png)
...
![**基于`stream`的操作**](./assets/CompressResponse_005.png)

**基于`buffer`的操作**

![基于`buffer`的操作](./assets/CompressResponse_006.png)
...
![运行结果](./assets/CompressResponse_007.png)
...
<Citation type="转载" source="粥里有勺糖的博客" url="https://sugarat.top/bigWeb/node/compress-response.html" />
