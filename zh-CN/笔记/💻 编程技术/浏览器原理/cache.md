...
![图片](./assets/Cache_001.png)

第一次运行输出

![图片](./assets/Cache_002.png)

查看Service Worker(生效)

![图片](./assets/Cache_003.png)

查看cache(里面有我们缓存的文件)

![图片](./assets/Cache_004.png)
...
![图片](./assets/Cache_005.png)

查看控制台(打印了``fetch source``,说明是从service worker中取的)

![图片](./assets/Cache_006.png)
...
![图片](./assets/Cache_009.png)

当资源失效时，返回 200 状态码和最新的资源

![图片](./assets/Cache_010.png)
...
<Citation type="转载" source="粥里有勺糖的博客" url="https://sugarat.top/bigWeb/browser/cache.html" />
