...
![图片](./assets/cache-002.png)

查看Service Worker(生效)

![图片](./assets/cache-003.png)

查看cache(里面有我们缓存的文件)

![图片](./assets/cache-004.png)
...
![图片](./assets/cache-005.png)

查看控制台(打印了``fetch source``,说明是从service worker中取的)

![图片](./assets/cache-006.png)
...
![图片](./assets/cache-009.png)

当资源失效时，返回 200 状态码和最新的资源

![图片](./assets/cache-010.png)
