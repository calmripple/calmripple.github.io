...
![图片](./jsencrypt-003.png)

**发送网络请求**

![图片](./jsencrypt-004.png)


**请求响应内容**

![图片](./jsencrypt-005.png)

大工告成,接入十分简单

[完整的示例代码仓库](https://github.com/ATQQ/demos/tree/main/asymmetric-encryption)

<Citation type="转载" source="粥里有勺糖的博客" url="https://sugarat.top/technology/learn/jsencrypt.html" />
