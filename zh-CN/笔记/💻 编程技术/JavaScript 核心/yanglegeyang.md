...
![图片](./yanglegeyang-004.png)

![图片](./yanglegeyang-005.png)

使用浏览器访问 `rootca.pro` 安装CA证书

![图片](./yanglegeyang-006.png)

配置完毕，不出意外的话，咱们打开羊了个羊就看见网络请求了

![图片](./yanglegeyang-007.png)
...
![图片](./yanglegeyang-012.png)

![图片](./yanglegeyang-013.png)

使用 whistle 直接发起请求

选择目标请求
![图片](./yanglegeyang-014.png)

修改参数，点击右上角小飞机发起请求

![图片](./yanglegeyang-015.png)
