...
![](./assets/MiniLottie_001.png)

② 选择需要导出的动画资源

![](./assets/MiniLottie_002.png)

③ 导出配置（小程序相关）

点击对应动画的设置

![](./assets/MiniLottie_003.png)

勾选 `Glyphs` 将用到的文字+字体导出为图形。

小程序里渲染不支持加载外部字体。

![](./assets/MiniLottie_004.png)
