...
![水平变换效果](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-001.jpeg)
...
![水平变换效果](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-004.jpeg)

从图中可以看出，并没有达到我们想要的效果。我们把网格平面旋转 30 度角的话，然后再进行同样的线性变换以后的效果，如下图所示

![水平变换效果](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-005.jpeg)

让我们来看下网格平面旋转60度角的时候的效果。

![水平变换效果](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-006.jpeg)

嗯嗯，这个看起来挺不错的样子。如果在精确一点的话，应该把网格平面旋转 58.28 度才能达到理想的效果。

![水平变换效果](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-007.jpeg)
...
![](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-010.jpeg)
...
![](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-011.jpeg)
...
![](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-012.jpeg)
...
![](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-013.jpeg)
...
![水平变换效果](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-017.jpeg)
...
![水平变换效果](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-018.jpeg)
...
![水平变换效果](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-019.jpeg)

如图所示，该图像主要由下面三部分构成。

![水平变换效果](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-020.jpeg)

我们将图像表示成 15 x 25 的矩阵，矩阵的元素对应着图像的不同像素，如果像素是白色的话，就取 1，黑色的就取 0. 我们得到了一个具有375个元素的矩阵，如下图所示

![水平变换效果](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-021.jpeg)
...
![水平变换效果](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-022.jpeg)
...
![水平变换效果](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-023.jpeg)
...
![水平变换效果](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-024.jpeg)

我们将数据用矩阵的形式表示：

![水平变换效果](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-025.jpeg)
...
![水平变换效果](./s-v-d-qi-yi-zhi-fen-jie-ji-qi-yi-yi-026.jpeg)
